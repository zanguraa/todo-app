...
export default function Todo(props) {
  ...
  return (
    <div className="flex justify-between items-center gap-2 px-2 bg-white p-2 max-w-[520px] w-full  rounded  h-12 border-b-2 border-[#E3E4F1]">
      <InputCheckbox>
        <p className=" flex-1 text-[#494C6B]">{props.todo.text}</p>
      </InputCheckbox>
